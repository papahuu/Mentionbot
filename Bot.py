...
async def start(event):
    ...
    await event.client.send_file(
        ...
        buttons=[
            ...
            [Button.url("❤️‍🔥 ɢʀᴏᴜᴘ 💫", "https://t.me/APNA_CLUB_09"), Button.url("❤️‍🔥 ᴄʜᴀɴɴᴇʟ 💫", "https://t.me/SWEETY_BOT_UPDATE")],
            [Button.url("❤️‍🔥 ᴘғᴘ ᴄʜᴀɴɴᴇʟ 💫", "https://t.me/LEGEND_SPARK"), Button.url("❤️‍🔥 ɪɴғᴏʀᴍᴀᴛɪᴏɴ  ❤️‍🔥", "https://t.me/PRINCE_WEBZ_INFO")]
        ]
    )
...
async def help(event):
    ...
    if not event.is_private:
        return await event.respond("ᴅᴇᴀʀ sᴛᴀʀᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴғ 🥺")
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ sᴡᴇᴇᴛʏ ᴍᴇɴᴛɪᴏɴ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [sᴡᴇᴇᴛʏ ʙᴏᴛ](https://t.me/SWEETY_BOT_UPDATE/)\n✪ ᴏғғɪᴄɪᴀʟ ᴍᴇᴍʙᴇʀ ᴏғ sᴡᴇᴇᴛʏ\n✪ ᴛᴇʟᴇɢʀᴀᴍ [ᴜsᴇʀ ɪᴅ ](https://t.me/PRINCE_WEBZ)\n✪ ғᴜᴛᴜʀᴇ ᴀɴᴇsᴛʜᴇᴛɪᴄ."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
...
print(">> sᴡᴇᴇᴛʏ ᴍᴇɴᴛɪᴏɴ BOT WORKING <<")
